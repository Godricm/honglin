...
{
    /// <summary>意向</summary>
    public partial class CustomerLink : Entity<CustomerLink>
    {
        #region 对象操作
        static CustomerLink()
        {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化CustomerLink[意向]数据……");

        //    var entity = new CustomerLink();
        //    entity.ID = 0;
        //    entity.Name = "abc";
        //    entity.Mobile = "abc";
        //    entity.IsLink = true;
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化CustomerLink[意向]数据！");
        //}
        ...
        public static CustomerLink FindByID(Int32 id)
        {
            if (id <= 0) return null;
